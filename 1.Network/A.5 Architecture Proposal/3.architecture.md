...
|------|------|-------------|------|
| 1 | `1.before.mermaid` | Network As-Is — pre-incident topology | [1.before.mermaid](https://github.com/meghaInfosec/Kavach_AI_Clinic/blob/main/1.Network/A.5%20Architecture%20Proposal/1.before.mermaid) |
| 2 | `2.after.mermaid` | Proposed Hardened Architecture — post-PCAP controls | [2.after.mermaid](https://github.com/meghaInfosec/Kavach_AI_Clinic/blob/main/1.Network/A.5%20Architecture%20Proposal/2.after.mermaid) |
