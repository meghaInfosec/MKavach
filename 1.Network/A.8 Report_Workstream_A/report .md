...
- [`architecture/before.svg`](./architecture/before.svg) / [`architecture/after.svg`](./architecture/after.svg) — Network architecture diagrams
- Evidence screenshots: `./Triage/Evidences/`
