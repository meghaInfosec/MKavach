...
|---|---|---|---|---|
| **F-01** | SQL Injection (SQLi) | [A03:2021-Injection](findings/A03%3A2021%20%E2%80%93%20Injection/SQL%20Injection/sqli.md) | DVWA | Code Patch (PDO Prepared Statement) |
| **F-02** | Reflected Cross-Site Scripting (XSS) | [A03:2021-Injection](findings/A03%3A2021%20%E2%80%93%20Injection/XSS_Reflected/Reflected_XSS.md) | DVWA | Code Patch (Output htmlspecialchars) |
| **F-03** | Insecure Direct Object Reference (IDOR) | [A01:2021-Broken Access Control](findings/A01%202021%3A%20Broken%20Access%20Control_IDOR/A-01_Broken_Access_Control.md) | Juice Shop | Code Patch (Session JWT Owner check) |
| **F-04** | Weak Auth & Missing Lockout | [A07:2021-Identification & Auth Failures](https://github.com/dc15jan-ux/KaVacH/blob/main/webapp/findings/A07%202021%3AIdentification%20and%20Authentication%20Failures/A07%20Identification%20and%20Authentication%20Failures%20Findings.md) | DVWA | Config Patch (Nginx Rate Limiting) |
