...
flowchart LR
    ...
    subgraph I2["ITER 2 · NETWORK"]
        WS_A["<b>WORKSTREAM A</b><br/><b>Network Forensics</b><br/>PCAP · Triage · Hypotheses<br/>IOCs · Architecture diff"]
        WS_B["<b>WORKSTREAM B</b><br/><b>Web App Assessment</b><br/>DVWA · Juice Shop<br/>Exploit · Patch · SAST"]
    end

    subgraph I3["ITER 3 · WEB"]
        SPACER[ ]
    end

    subgraph I4["ITER 4 · SYNTHESIS"]
        WS_C["<b>WORKSTREAM C</b><br/><b>Synthesis</b><br/>Joint threat model<br/>Defense in depth"]
        BOARD["<b>BOARD READOUT</b>"]
    end
    ...
    style WS_A fill:#FADADD,stroke:#C08090,color:#5C1A2A
    style WS_B fill:#D4EDDA,stroke:#7BAF8C,color:#1A3D2A
    style WS_C fill:#EDE0F0,stroke:#9B7BB0,color:#3D1A5C
    style BOARD fill:#1A2E4A,stroke:#1A2E4A,color:#FFFFFF
    style SPACER fill:none,stroke:none,color:none
    style I1 fill:#FFFDF7,stroke:#E0D5C0
    style I2 fill:#FFFDF7,stroke:#E0D5C0
    style I3 fill:#FFFDF7,stroke:#E0D5C0
    style I4 fill:#FFFDF7,stroke:#E0D5C0
```
